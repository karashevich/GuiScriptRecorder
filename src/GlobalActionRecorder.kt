...
object GlobalActionRecorder {
    ...
    fun activate() {
        ...
        IdeEventQueue.getInstance().addDispatcher(globalAwtProcessor, null) //todo: add disposal dependency on component
        isActive = true
    }
    ...
    fun deactivate() {
        if (isActive) {
            ...
            IdeEventQueue.getInstance().removePostprocessor(globalAwtProcessor)
        }
        isActive = false
    }
